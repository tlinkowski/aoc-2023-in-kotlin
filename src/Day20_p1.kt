...
//    }
//
//    fun System.pressMainButton(pulseCounts: MutableMap<Pulse, Long>): Map<Pulse, Long> {
//        var signals = listOf(Signal("button", Pulse.LOW, "broadcaster"))
//        while (signals.isNotEmpty()) {
//            signals.forEach { s ->
//                println("${s.source} -${s.pulse}-> ${s.target}")
//                pulseCounts[s.pulse] = pulseCounts[s.pulse]!! + 1L
//            }
...
//
//    // main button 1000 times
//    fun part1(input: List<String>): Long {
//        val system = input.parseSystem().updateConjunctionModules()
//        val pulseCounts = mutableMapOf(Pulse.LOW to 0L, Pulse.HIGH to 0L)
//
//        for (i in 1..1000) {
//            println("Step $i")
//            system.pressMainButton(pulseCounts)
//            println(pulseCounts)
//        }
//
//        return pulseCounts[Pulse.LOW]!! * pulseCounts[Pulse.HIGH]!!
//    }
//
