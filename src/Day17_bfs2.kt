...
//            println("First cur p=${cur[0].p}, loss=${cur[0].heatLoss}")
            cur = cur.flatMap { c ->
                ...
                .values
                .toList()
//            val maxHeatLoss = cur.minOf { maxHeatLoss(it) }
//            fun Moment.alreadyLostTooMuchHeat() = heatLoss + minExtraHeatLoss(this) > maxHeatLoss
//            cur = cur.filter { !it.alreadyLostTooMuchHeat() }
